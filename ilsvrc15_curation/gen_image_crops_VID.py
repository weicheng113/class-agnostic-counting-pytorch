        ...
        for j in range(len(all_dirs_level2)):
            ...
            for k in range(len(frame_list)):
                ...
                try:
                    ...
                    if ex.msg.startswith("no element found"):
                        print(f"empty file: {frame_xml_name}")
                        continue
                    raise xml.etree.ElementTree.ParseError(f"{ex.msg}. file: {frame_xml_name}")
...
if __name__ == "__main__":
    ...
    # empty file: /media/cwei/WD_BLACK/datasets/ILSVRC2015/Annotations/VID/train/val/ILSVRC2015_val_00102000/000044.xml
    # Cannot find /media/cwei/WD_BLACK/datasets/ILSVRC2015/Data/VID/train/val/ILSVRC2015_val_00108000/000005.JPEG
